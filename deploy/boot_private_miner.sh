...
geth --nodiscover --mine --unlock ${COINBASE//\"/} --password $1 --identity "ConsentChain" --rpc --rpcaddr localhost --rpcport "8545" --rpccorsdomain "*" --datadir "~/.consent" --port "30303" --rpcapi "db,eth,net,personal,admin,web3" --networkid 1969 console
