...
contract ConsentFactory {
    ...
    /* 
     * This structure is the template for the consent, it contains jurisidiction and language
     * that the consent is in. This is used when a new consent is created for a specific user.
     * 
     * If the language is empty, i.e. "", it is used whenever there is no language match
     * if the jurisdiction is empty, i.e. "", it is used whenever there is no country match
     *
     */
    ...
    struct ConsentCountry {
      mapping (string => ConsentLanguage) consentLanguages;
    };

    struct ConsentLanguage {
      mapping (string => ConsentTemplate) consentTemplates;
    }
    
    /* Different types of consents based on the purpouse of the consent */
    mapping (string => ConsentCountry) consentCountries;
    
    /* Events generated by this contract */
    ...
    function createConsent (address _user, string _purpouse)
    {
